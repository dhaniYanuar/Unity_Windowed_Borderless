...
//#endif
    ...
    public static void SetFramelessWindow(Vector2Int borderSize)
    {
        var hwnd = GetActiveWindow();
        SetWindowLong(hwnd, GWL_STYLE, WS_POPUP | WS_VISIBLE);
        framed = false;
        BorderlessWindow.MoveWindowPos(Vector2Int.zero, borderSize.x, borderSize.y); // Compensating the border offset.
    }

    public static void SetFramedWindow(Vector2Int borderSize)
    {
        var hwnd = GetActiveWindow();
